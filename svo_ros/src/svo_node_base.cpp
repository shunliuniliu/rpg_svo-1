...
//
  ...
  svo_interface_.saveTimeLog("/home/euclid/svo_install_overlay_ws/tmpLog.txt");
  std::cout << "move on saving the track log!" << std::endl;
  svo_interface_.saveAllFrameTrack("/home/euclid/svo_install_overlay_ws/tmpTrack.txt");
